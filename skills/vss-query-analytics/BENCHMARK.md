...
- MEDIUM SECURITY/Unknown (SQP-2): The skill references sensitive environment variables ($NGC_CLI_API_KEY and $NVIDIA_API_KEY) in its prerequisites without (`SKILL.md:18`)
