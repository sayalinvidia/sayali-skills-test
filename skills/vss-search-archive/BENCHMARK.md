...
- LOW SCHEMA/unexpected_file: Unexpected 'skill-card.md' in skill root (`skills/vss-search-archive/skill-card.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'skill.oms.sig' in skill root (`skills/vss-search-archive/skill.oms.sig`)
