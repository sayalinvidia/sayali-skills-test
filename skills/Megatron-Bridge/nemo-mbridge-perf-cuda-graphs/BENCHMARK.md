...
- MEDIUM QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.author' (`skills/nemo-mbridge-perf-cuda-graphs/SKILL.md`)
- MEDIUM QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.tags' (`skills/nemo-mbridge-perf-cuda-graphs/SKILL.md`)
...
- Inter-Skill Deduplication: Parsed skill 'nemo-mbridge-perf-cuda-graphs': 167 char description
